    ...
    render() {
        ...
        return(
            <div className="col-1 room-avatar-col">
                ...
                <img onClick={this.handleClick} className={this.props.speakingPeers.includes(this.props.userId, 0) ? "room-avatar rounded-circle w-15 speaking" : "room-avatar rounded-circle w-15"} src={'/images/avatars/' + avatar + '-avatar.png'} />
